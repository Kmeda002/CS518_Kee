...
<div class="container">
  ...
  <br>
  <form class="form-horizontal" action="change_password_action.php" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="currentpwd">Current Password:</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="password" class="form-control" id="newpwd" placeholder="Current Password" name="newpwd">
      </div>
    </div>
    <div class="form-group">
